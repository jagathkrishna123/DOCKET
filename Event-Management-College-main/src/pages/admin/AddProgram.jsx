...
const AddProgram = () => {
  ...
  useEffect(() => {
    if (existingProgram) {
      ...
      setDate(existingProgram.programDate ? existingProgram.programDate.split('T')[0] : "");
      setTime(existingProgram.programTime || "");
      setDescription(existingProgram.description || "");
      setFeatures(existingProgram.features || []);
      setImagePreview(existingProgram.images ? `${API_BASE_URL}/uploads/${existingProgram.images}` : null);
    }
  }, [existingProgram]);
